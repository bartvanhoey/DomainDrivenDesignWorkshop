...
{
    [DbContext(typeof(IssueTrackingMigrationsDbContext))]
    [Migration("20210114202326_LastCommentTimeAdded")]
    partial class LastCommentTimeAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IssueTracking.Domain.Issues.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("IssueTracking.Domain.Issues.Issue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IssueTracking.Domain.Issues.IssueLabel", b =>
                {
            ...
            modelBuilder.Entity("IssueTracking.Domain.Issues.Comment", b =>
                {
                    b.HasOne("IssueTracking.Domain.Issues.Issue", "Issue")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("IssueTracking.Domain.Issues.IssueLabel", b =>
                {
                    b.HasOne("IssueTracking.Domain.Issues.Issue", null)
                        .WithMany("Labels")
                        .HasForeignKey("IssueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
